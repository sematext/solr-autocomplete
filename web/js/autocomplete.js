 ...
 */
YAHOO.widget.AutoComplete.prototype.applyLocalFilter = false;
 ...
 * @default true
 */
YAHOO.widget.AutoComplete.prototype.resultTypeList = false;
...
YAHOO.widget.AutoComplete.prototype.formatResult = function(oResultData, sQuery, sResultMatch) {
    var sKey = sResultMatch 	    
	   ...
	   var aMarkup = ["<div class='myCustomResult'>", 
	       sKey.replace(sQuery, "<b>" + sQuery + "</b>"), 
	      "</div>"]; 
	  return (aMarkup.join("")); 
};
...
YAHOO.widget.AutoComplete.prototype._selectItem = function(elListItem) {
    ...
    // example for getting a value of another form field for inclusion in the final URL
    // var lang = document.getElementById("selectTypeId");

    // modify desired action/URL
    // example for Sematext Wikipedia AutoComplete demo
    // parent.baseFrame.location.href = "http://" + lang.options[lang.selectedIndex].value + ".wikipedia.org/wiki/" + elListItem._sResultMatch.replace(" ", "_");
    parent.baseFrame.location.href = "http://CHANGE.TO.YOUR.SERVER.HERE/search?q=" + elListItem._sResultMatch;
};
